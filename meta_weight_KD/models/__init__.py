from .resnet import resnet20, resnet32, resnet38, resnet56, resnet110, resnet116, resnet14x2, resnet38x2, resnet110x2
from .resnet import resnet8x4, resnet14x4, resnet32x4, resnet38x4
from .resnetv2 import ResNet50 # resnet50 for cifar100 from Rep 
...
from .wrn import wrn_16_1, wrn_16_2, wrn_40_1, wrn_40_2 # from Rep
...
model_dict = {
    ...
    'resnet50': ResNet50,# resnet50 for cifar100
    'vgg8': vgg8_bn,
    'vgg13': vgg13_bn,
